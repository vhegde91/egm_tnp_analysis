...
flags = {
    ...
    'passingCutBasedLooseNoIso94X'  :   '(passingCutBasedLooseNoIso94X == 1)',
    'passingCutBasedMediumNoIso94X' :   '(passingCutBasedMediumNoIso94X == 1)',
    'passingCutBasedTightNoIso94X'  :   '(passingCutBasedTightNoIso94X == 1)',
    'passingCutBasedVetoNoIso94X'   :   '(passingCutBasedVetoNoIso94X == 1)',
