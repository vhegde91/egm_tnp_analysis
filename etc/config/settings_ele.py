...
flags = {
    ...
    #------------------ CutBasedNoIso94XV2 ---------------------
    'passingCutBasedVetoNoIso94XV2' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.012600 && abs(el_dEtaSeed)     < 0.004630 && abs(el_dPhiIn)       < 0.148000 && el_hoe               < (0.05+(1.16/el_sc_e)+(0.0324*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.209000 && el_mHits            <= 2 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.045700 && abs(el_dEtaSeed)     < 0.008140 && abs(el_dPhiIn)       < 0.190000 && el_hoe               < (0.05+(2.54/el_sc_e)+(0.183*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.132000 && el_mHits            <= 3 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
    'passingCutBasedLooseNoIso94XV2' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.011200 && abs(el_dEtaSeed)     < 0.003770 && abs(el_dPhiIn)       < 0.088400 && el_hoe               < (0.05+(1.16/el_sc_e)+(0.0324*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.193000 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.042500 && abs(el_dEtaSeed)     < 0.006740 && abs(el_dPhiIn)       < 0.169000 && el_hoe               < (0.0441+(2.54/el_sc_e)+(0.183*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.111000 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
    'passingCutBasedMediumNoIso94XV2' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.010600 && abs(el_dEtaSeed)     < 0.003200 && abs(el_dPhiIn)       < 0.054700 && el_hoe               < (0.046+(1.16/el_sc_e)+(0.0324*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.184000 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.038700 && abs(el_dEtaSeed)     < 0.006320 && abs(el_dPhiIn)       < 0.039400 && el_hoe               < (0.0275+(2.52/el_sc_e)+(0.183*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.072100 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
    'passingCutBasedTightNoIso94XV2' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.010400 && abs(el_dEtaSeed)     < 0.002550 && abs(el_dPhiIn)       < 0.022000 && el_hoe               < (0.026+(1.15/el_sc_e)+(0.0324*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.159000 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.035300 && abs(el_dEtaSeed)     < 0.005010 && abs(el_dPhiIn)       < 0.023600 && el_hoe               < (0.0188+(2.06/el_sc_e)+(0.183*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.019700 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
    #------------------ CutBasedNoIso94XV1 ---------------------
    'passingCutBasedVetoNoIso94XV1' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.012800 && abs(el_dEtaSeed)     < 0.005230 && abs(el_dPhiIn)       < 0.159000 && el_hoe               < (0.05+ (1.12/el_sc_e) + (0.0368*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.193000 && el_mHits            <= 2 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.044500 && abs(el_dEtaSeed)     < 0.009840 && abs(el_dPhiIn)       < 0.157000 && el_hoe               < (0.05 + (0.5/el_sc_e) + (0.201*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.096200 && el_mHits            <= 3 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
    'passingCutBasedLooseNoIso94XV1' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.010500 && abs(el_dEtaSeed)     < 0.003870 && abs(el_dPhiIn)       < 0.071600 && el_hoe               < (0.05+ (1.12/el_sc_e) + (0.0368*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.129000 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.035600 && abs(el_dEtaSeed)     < 0.007200 && abs(el_dPhiIn)       < 0.147000 && el_hoe               < (0.0414 + (0.5/el_sc_e) + (0.201*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.087500 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
    'passingCutBasedMediumNoIso94XV1' : '( (el_sc_abseta<=1.479 && el_5x5_sieie         < 0.010500 && abs(el_dEtaSeed)     < 0.003650 && abs(el_dPhiIn)       < 0.058800 && el_hoe               < (0.026+ (1.12/el_sc_e) + (0.0368*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.032700 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)           < 0.050000 && abs(el_dz)           < 0.100000)||(el_sc_abseta>1.479 && el_5x5_sieie         < 0.030900 && abs(el_dEtaSeed)     < 0.006250 && abs(el_dPhiIn)       < 0.035500 && el_hoe               < (0.026 + (0.5/el_sc_e) + (0.201*rho/el_sc_e)) && abs(el_1overEminus1overP) < 0.033500 && el_mHits            <= 1 && passingConvVeto     == 1 && abs(el_dxy)          < 0.100000 && abs(el_dz)           < 0.200000))',
